...
import { AppEffects, appReducer, ExternalInformationEffects, externalInformationReducer, IDBEffects, modeReducer, TaskEffects } from './app/store';
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    provideEffects(AppEffects, ModeEffects, ExternalInformationEffects, IDBEffects, TaskEffects),
